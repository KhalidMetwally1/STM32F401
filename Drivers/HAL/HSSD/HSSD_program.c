...
static u32 Local_u32SSDNumbers[10] = SSD_NUMBER_ARR ;
/*==============================================================================================================*/
/*
 ...
 * Parameters :
 	 	 	 =>Structure has the SSD type , data port and section, output type, speed and enable(port & pin)
			 =>Copy_u8Number --> desired number [ 0 : 9 ]
 * return : void
 */
void SSD_voidSendNumber       ( SSD_Type Copy_SSDConfig , u8 Copy_u8Number )
{
	...
	{
		MGPIO_voidSetPortValue (Copy_SSDConfig.DataPort, Copy_SSDConfig.DataSection, Local_u32SSDNumbers[Copy_u8Number]);
	}
...
void SSD_voidEnable           ( SSD_Type Copy_SSDConfig )
{
	if( Copy_SSDConfig.Type == SSD_COMMON_CATHODE )
	{
		MGPIO_voidSetPinDirection	(Copy_SSDConfig.EnablePort, Copy_SSDConfig.EnablePin, OUTPUT);
		MGPIO_voidSetPinValue		(Copy_SSDConfig.EnablePort, Copy_SSDConfig.EnablePin, MGPIO_LOW);
	}
	else if( Copy_SSDConfig.Type == SSD_COMMON_ANODE )
	{
		MGPIO_voidSetPinDirection	(Copy_SSDConfig.EnablePort, Copy_SSDConfig.EnablePin, OUTPUT);
		MGPIO_voidSetPinValue		(Copy_SSDConfig.EnablePort, Copy_SSDConfig.EnablePin, MGPIO_HIGH);
	}
}
/*==============================================================================================================*/
/*
